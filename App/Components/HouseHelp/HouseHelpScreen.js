...
const HouseHelpScreen = () => {
  ...
  const fetchHouseHelpData = async () => {
    try {
      const response = await axios.get(
        "https://society.zacoinfotech.com/api/househelp/",
        {
          headers: {
  ...
  const filteredData = houseHelpList.filter(
    (item) =>
                    ...
                    <>
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_name || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_pan_number || "N/A"}
                        </Text>
                      </View>

                      <View style={styles.infoContainer}>
                        <Text style={styles.label}>PAN Document:</Text>
                        <Text style={styles.value}>
                          {selectedItem?.house_help_pan_doc ? (
                            <Text
                              style={{ color: "blue" }}
                              onPress={() =>
                                Linking.openURL(selectedItem.house_help_pan_doc)
                              }
                            >
                              View PAN Document
                            </Text>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_contact || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_aadhar_number || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_aadhar_doc ? (
                            <Text
                              style={{ color: "blue" }}
                              onPress={() =>
                                Linking.openURL(
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_city || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_state || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.house_help_pin || "N/A"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text style={styles.value}>
                          {selectedItem?.other_doc ? (
                            <Text
                              style={{ color: "blue" }}
                              onPress={() =>
                                Linking.openURL(selectedItem.other_doc)
                              }
                            >
                              View Other Document
                            </Text>
                      ...
                      <View style={styles.infoContainer}>
                        ...
                        <Text>
                          {selectedItem?.house_help_address || "N/A"}
                        </Text>
              ...
              <View style={styles.container2}>
                ...
                <View>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#808080"
                    value={houseHelpList.contact_no}
                ...
                <View>
                  ...
                  <TextInput
                    ...
                    value={houseHelpList.visit_purpose}
                    onChangeText={(value) =>
                ...
                <View>
                  ...
                  <TextInput
                    ...
                    value={houseHelpList.additional_note}
                    onChangeText={(value) =>
